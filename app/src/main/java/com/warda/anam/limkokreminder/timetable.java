...
public class timetable extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv4.setImageResource(R.drawable.day);
	...
	public void onClick(View v) {
		...
		case R.id.home:
		case R.id.back:
			Intent myIntent = new Intent(timetable.this, MainActivity.class);
		...
		case 7:
			ll.removeAllViews();
			editclas=db.getClas(Integer.parseInt(et4.getText().toString()));
			et.setText(editclas.getName());
			et1.setText(editclas.getVenue());
			et2.setText(editclas.getDay());
			et3.setText(editclas.getTime());
			...
			break;
		case 8:
			db.deleteClas(db.getClas(Integer.parseInt(et4.getText().toString())));
			Intent myIntent3 = new Intent(timetable.this, timetable.class);
		    startActivity(myIntent3);
			break;
		case 9:
			editclas.setName(et.getText().toString());
			editclas.setVenue(et1.getText().toString());
			editclas.setDay(et2.getText().toString());
			editclas.setTime(et3.getText().toString());
			
			db.updateClas(editclas);
			Intent myIntent2 = new Intent(timetable.this, timetable.class);
		...
		case R.id.add:	
			...
			break;
		case 5:
			db.addClas(new clas(et.getText().toString(),et1.getText().toString(),et2.getText().toString(),et3.getText().toString()));
			Intent myIntent1 = new Intent(timetable.this, timetable.class);
